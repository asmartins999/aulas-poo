...
class Lutador{
	...
	public function apresentar(){
		...
		print_r("Detentor de ".$this->getVitorias()." vitórias! <br>");
		print_r("Com apenas ".$this->getDerrotas()." derrota! <br>");
		print_r("E ".$this->getEmpates()." empates <br>");
		print_r("Ele, o ainda campeão: ".$this->getNome()."<br>");
		print_r("<hr>");
	}
